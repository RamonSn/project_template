...
set_theme <- function(
  ...
  if (is.na(y_title_size)) {
    ...
    # y-title margin
    if (!is.null(y_title_margin)) {
      y_title_margin_ <- str_c("margin = margin(", y_title_margin, ")")
    } else {
      y_title_margin_ <- ""
    }
    ...
    # y-title color
    if (!is.null(y_title_color)) {
      y_title_color_ <- str_c("color = '", y_title_color, "'")
    } else {
      y_title_color_ <- ""
    }
  ...
  if (is.na(x_title_size)) {
    ...
    # x-title margin
    if (!is.null(x_title_margin)) {
      x_title_margin_ <- str_c("margin = margin(", x_title_margin, ")")
    } else {
      x_title_margin_ <- ""
    }

    # x-title color
    if (!is.null(x_title_color)) {
      x_title_color_ <- str_c("color = '", x_title_color, "'")
    } else {
      x_title_color_ <- ""
    }
